...
function App() {
    ...
    const API_KEY = "495b9bc3cadae8632549c1556d3924d8"
        ...
        <Head/>
            <header className="center-max-size header">
                ...
                <form className="form" onSubmit={fetchMovies}>
                    <input placeholder="Search movie here" className="search" type="text" id="search"
                           onInput={(event) => setSearchKey(event.target.value)}/>
                            <Button className="submit-search" type="submit" variant="dark">Submit</Button>
                </form>
            </header>
            {movies.length ?
                <main>
